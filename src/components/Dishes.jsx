...
const Dishes = () => {
    return (
        <div className="min-h-screen flex flex-col justify-center items-center lg:px-32 px-5">
            ...
            {/* Desi */}
            <div id="desi" className="w-full mb-16">
                <h2 className="text-2xl font-semibold mb-6 text-center">Desi Cuisine</h2>
                <div className="flex flex-wrap gap-8 justify-center">
                    <DishCard img={img1} title="Desi Cuisine" price="500"/>
                    <DishCard img={img2} title="Desi Cuisine" price="500"/>
                    <DishCard img={img3} title="Desi Cuisine" price="500"/>
                </div>
            </div>

            {/* Vegetarian */}
            <div id="vegetarian" className="w-full mb-16">
                <h2 className="text-2xl font-semibold mb-6 text-center">Vegetarian</h2>
                <div className="flex flex-wrap gap-8 justify-center">
            ...
            {/* Fast Food */}
            <div id="fastfood" className="w-full mb-16">
                <h2 className="text-2xl font-semibold mb-6 text-center">Fast Food</h2>
                <div className="flex flex-wrap gap-8 justify-center">
